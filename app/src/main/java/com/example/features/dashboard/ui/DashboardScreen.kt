...
fun DashboardScreen(
    ...
    val activePgName = currentProperty?.propertyName ?: profile?.pgName ?: "Emerald Stays"
                ...
                title = {
                    Row(
                        ...
                        modifier = Modifier
                            ...
                            .clickable { showPropertySheet = true }
        ...
        item {
            ...
            Row(
                ...
                DashboardKpiCard(
                    ...
                    value = "₹${String.format("%,.0f", summary.expenses.totalExpenses)}",
