        ...
        when (val state = uiState) {
            ...
            is ReportsUiState.Success -> {
                ...
                Column(
                    ...
                    Text("Highest Expense Categories", style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.Bold)
                    data.categoryBreakdown.forEach { point ->
                        Card(modifier = Modifier.fillMaxWidth()) {
                            Row(
                                modifier = Modifier
                                    .fillMaxWidth()
                                ...
                                Text("₹${String.format("%,.0f", point.value)}", fontWeight = FontWeight.Bold, color = MaterialTheme.colorScheme.error)
                            }
                        }
                    }
                }
